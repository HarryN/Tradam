          ...
          <div className="space-y-4">
            {orders.length === 0 ? (
              ...
              orders.slice(0, 3).map((order) => (
                <div key={order.id} className="bg-white p-5 rounded-2xl border border-neutral-border shadow-xs flex items-center justify-between group hover:shadow-md transition-all">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-neutral-bg flex items-center justify-center text-neutral-muted">
                      <Package className="w-6 h-6" />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-neutral-text">Order #{order.id.slice(0, 8)}</p>
